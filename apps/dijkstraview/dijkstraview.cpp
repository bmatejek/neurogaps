...
static RNScalar voxel_size = 2.0;
...
static int UpdatePath(void)
{
   ...
   int human_label_index = (int)(human_label_grid->GridValue(iv) + 0.5);

   int path_index = iv;
   while (path_index != -1) {
      // get this human label
      int path_human_label_index = (int)(human_label_grid->GridValue(path_index) + 0.5);
